...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/en/eu-ai-act-compliance`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
    { url: `${SITE_URL}/es/cumplimiento-eu-ai-act`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
    { url: `${SITE_URL}/pt/conformidade-eu-ai-act`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
    { url: `${SITE_URL}/es/calculadora/05`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
