...
import { EuAiActCalculator } from "@/components/euaiact/EuAiActCalculator";
import { EuAiActLanguageBar } from "@/components/euaiact/EuAiActLanguageBar";
...
export function EuAiActPage({ locale }: { locale: Locale }) {
  ...
  return (
    <div className="py-12 md:py-16 bg-background">
      ...
      <div className="container mx-auto px-4 max-w-3xl">
        <EuAiActLanguageBar activeLocale={locale} />
        ...
        <div className="mb-8 space-y-2">
          <p className="text-xs text-muted-foreground text-center">{copy.meta.regNote}</p>
          <p className="text-xs text-brand-navy bg-surface border border-border-hairline rounded-lg p-3 leading-relaxed">
            {copy.meta.privacyWarning}
          </p>
        </div>

        <EuAiActCalculator locale={locale} route={route} />
