...
export const RECOMMENDATION_TEMPLATES: RecommendationTemplate[] = [
  ...
  {
    key: "dora-marco-riesgos",
    title: {
      es: "Fortalecer el marco de gestión de riesgos TIC",
      en: "Strengthen the ICT risk management framework",
      pt: "Fortalecer o framework de gestão de riscos de TIC",
    },
    description: {
      es: "Documente y someta a aprobación del órgano de administración un marco integral que cubra identificación, protección, detección, respuesta y recuperación, con revisiones periódicas y responsabilidades claras.",
      en: "Document and submit for management body approval a comprehensive framework covering identification, protection, detection, response, and recovery, with periodic reviews and clear responsibilities.",
      pt: "Documente e submeta à aprovação do órgão de administração um framework integral que cubra identificação, proteção, detecção, resposta e recuperação, com revisões periódicas e responsabilidades claras.",
    },
    priority: "critica",
    effort: "alto",
    impact: "alto",
  ...
  {
    key: "dora-inventario-activos",
    title: {
      es: "Mantener inventario de activos TIC clasificado por criticidad",
      en: "Maintain an ICT asset inventory classified by criticality",
      pt: "Manter inventário de ativos de TIC classificado por criticidade",
    },
    description: {
      es: "Actualice y clasifique hardware, software, datos y dependencias por criticidad para mejorar la visibilidad y el monitoreo continuo de riesgos exigido por DORA.",
      en: "Update and classify hardware, software, data, and dependencies by criticality to improve visibility and continuous risk monitoring required by DORA.",
      pt: "Atualize e classifique hardware, software, dados e dependências por criticidade para melhorar a visibilidade e o monitoramento contínuo de riscos exigido pelo DORA.",
    },
    priority: "alta",
    effort: "medio",
    impact: "alto",
  ...
  {
    key: "dora-pruebas-resiliencia",
    title: {
      es: "Implementar programa estructurado de pruebas de resiliencia",
      en: "Implement a structured resilience testing program",
      pt: "Implementar programa estruturado de testes de resiliência",
    },
    description: {
      es: "Ejecute escaneos de vulnerabilidades y pruebas de penetración avanzadas en sistemas críticos, documente resultados y remediación en plazos definidos, e intégrelo al marco de riesgos.",
      en: "Run vulnerability scans and advanced penetration tests on critical systems, document results and remediation within defined timeframes, and integrate them into the risk framework.",
      pt: "Execute varreduras de vulnerabilidades e testes de penetração avançados em sistemas críticos, documente resultados e remediação em prazos definidos e integre-os ao framework de riscos.",
    },
    priority: "alta",
    effort: "alto",
    impact: "alto",
  ...
  {
    key: "dora-proveedores-tic",
    title: {
      es: "Estandarizar gestión de proveedores TIC críticos",
      en: "Standardize critical ICT provider management",
      pt: "Padronizar gestão de provedores críticos de TIC",
    },
    description: {
      es: "Mantenga un registro completo de contratos con cláusulas de resiliencia, evalúe riesgos de concentración y integre los riesgos de terceros al marco general de gestión.",
      en: "Maintain a complete contract register with resilience clauses, assess concentration risk, and integrate third-party risks into the overall management framework.",
      pt: "Mantenha um registro completo de contratos com cláusulas de resiliência, avalie riscos de concentração e integre os riscos de terceiros ao framework geral de gestão.",
    },
    priority: "alta",
    effort: "medio",
    impact: "alto",
  ...
  {
    key: "dora-reporte-incidentes",
    title: {
      es: "Formalizar clasificación y reporte de incidentes mayores",
      en: "Formalize major incident classification and reporting",
      pt: "Formalizar classificação e reporte de incidentes maiores",
    },
    description: {
      es: "Defina un plan de respuesta con detección temprana, contención y notificación, y asegure el reporte a autoridades competentes dentro de los plazos DORA.",
      en: "Define a response plan with early detection, containment, and notification, and ensure reporting to competent authorities within DORA timeframes.",
      pt: "Defina um plano de resposta com detecção precoce, contenção e notificação, e assegure o reporte às autoridades competentes dentro dos prazos do DORA.",
    },
    priority: "critica",
    effort: "medio",
    impact: "alto",
  ...
  {
    key: "dora-analisis-codigo",
    title: {
      es: "Integrar SAST, DAST, SCA y calidad de código en el SDLC",
      en: "Integrate SAST, DAST, SCA, and code quality into the SDLC",
      pt: "Integrar SAST, DAST, SCA e qualidade de código no SDLC",
    },
    description: {
      es: "Incorpore análisis estático, dinámico, composición de software y escaneo de calidad en el desarrollo para detectar vulnerabilidades temprano y generar evidencia auditable para DORA.",
      en: "Embed static, dynamic, composition, and quality analysis in development to detect vulnerabilities early and generate auditable evidence for DORA.",
      pt: "Incorpore análise estática, dinâmica, composição de software e varredura de qualidade no desenvolvimento para detectar vulnerabilidades cedo e gerar evidências auditáveis para o DORA.",
    },
    priority: "alta",
    effort: "medio",
    impact: "alto",
  ...
  {
    key: "dora-cultura-resiliencia",
    title: {
      es: "Promover cultura de sensibilización en resiliencia",
      en: "Promote a resilience awareness culture",
      pt: "Promover cultura de sensibilização em resiliência",
    },
    description: {
      es: "Capacite regularmente al personal y al órgano de administración, participe en intercambio de inteligencia de amenazas y alinee estrategia de negocio con resiliencia operativa.",
      en: "Regularly train staff and the management body, participate in threat intelligence sharing, and align business strategy with operational resilience.",
      pt: "Capacite regularmente o pessoal e o órgão de administração, participe do compartilhamento de inteligência de ameaças e alinhe a estratégia de negócio com a resiliência operacional.",
    },
    priority: "media",
    effort: "bajo",
    impact: "medio",
