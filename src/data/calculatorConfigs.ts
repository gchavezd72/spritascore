...
export const CALCULATOR_CONFIGS: CalculatorConfig[] = [
  ...
  },
  {
    ...
    category: "seguridad",
    customRoute: "/es/calculadora/05",
    title: { es: "Costo de vulnerabilidad por sector", en: "Cost of vulnerability by sector", pt: "Custo de vulnerabilidade por setor" },
    shortDescription: {
      es: "Estime el impacto financiero de una vulnerabilidad según sector, volumen de datos, uso de IA, SCA y madurez AppSec — 6 preguntas, resultado en R$ o USD.",
      en: "Estimate the financial impact of a vulnerability by sector, data volume, AI use, SCA, and AppSec maturity — 6 questions, result in BRL or USD.",
      pt: "Estime o impacto financeiro de uma vulnerabilidade por setor, volume de dados, uso de IA, SCA e maturidade AppSec — 6 perguntas, resultado em R$ ou USD.",
    },
    kicker: {
      es: "6 preguntas · 2–3 minutos · BRL o USD",
      en: "6 questions · 2–3 minutes · BRL or USD",
      pt: "6 perguntas · 2–3 minutos · BRL ou USD",
    },
    badge: {
      es: "Calculadora 05",
      en: "Calculator 05",
    ...
    ctaLabel: {
      es: "Calcular costo por sector",
      en: "Calculate sector cost",
      pt: "Calcular custo por setor",
    },
    complexity: "media",
    estimatedTime: { es: "2 a 3 minutos", en: "2 to 3 minutes", pt: "2 a 3 minutos" },
    /** Self-contained wizard at /[locale]/calculadora/05 — see src/components/calc05 */
    steps: [],
  },
  {
    id: "aspm-cost",
